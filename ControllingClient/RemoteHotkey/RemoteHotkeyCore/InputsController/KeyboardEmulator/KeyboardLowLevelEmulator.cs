...
public class KeyboardLowLevelEmulator
{
    public void Send(ScanCodeShort key, KEYEVENTF flag)
    {
        INPUT[] Inputs = new INPUT[1];
        INPUT Input = new INPUT();
        Input.type = 1; // 1 = KeyboardLowLevelEmulator Input
    ...
    public enum VirtualKeyShort : short
    {
        ...
        ///The VK_PACKET key is the low word of key 32-bit Virtual Key value used for non-keyboard input methods. For more information,
